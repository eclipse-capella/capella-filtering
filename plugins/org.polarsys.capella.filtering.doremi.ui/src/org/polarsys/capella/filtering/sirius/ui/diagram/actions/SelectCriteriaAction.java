...
/**
 * Action to open a dialog box where the user can select the diagram Product Line features which should be selected in
 * the diagram.
 * 
 * 
 */
...
public class SelectCriteriaAction extends FilteringDiagramAction {
  ...
  private final class FeaturesSelectionCommand extends AbstractTransactionalCommand {
    ...
    protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
      ...
      DiagramElementsSelectionDialogWithExtraCheckbox dlg = new DiagramElementsSelectionDialogWithExtraCheckbox(TITLE,
          MESSAGE, CHECKBOX_MESSAGE, false);
      ...
      if (executed) {
        ...
        StructuredSelection diagramSelected = (StructuredSelection) editorSite.getSelectionProvider().getSelection();
        ...
        // Select elements
        SiriusDiagramEditorUtil.selectWithoutRevealElementsInDiagram(getDiagramWorkbenchPart(), editPartsToSelect);
  ...
  /**
   * This method is a modification of EditPart.findEditPart because it does not handle Edges
   **/
