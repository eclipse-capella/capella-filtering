...
public class FilteringSiriusUtils {
	...
	/**
	 * Check if all elements associated to a given feature are visible in a
	 * given diagram
	 * 
	 * @param diagram
	 * @param feature
			...
			if (o instanceof DDiagramElement) {
				...
				for (EObject semanticElement : getRealSemanticElements(diagramElement)) {
					List<FilteringCriterion> associatedCriteria = FilteringUtils
							.getAssociatedCriteria(semanticElement);
	...
	/**
	 * This methods retrieves the semantic elements of a given diagram element.
	 * It was needed for the special case of breakdown diagram edges that does
	 * not contains semantic elements
	 * 
	 * @param diagram
	 *            element
	...
	/**
	 * Check if a diagram element represent melody elements Used mainly for
	 * decorators
	 * 
	 * @param element
	 * @return
	...
	/**
	 * Given a list of elements it checks if all elements associated to a
	 * feature are in this list
	 * 
	 * @param diagram
	 * @param elements
	 * @param feature
	...
	/**
	 * Get the explicit associated criteria of a diagram element semantic
	 * elements
	 * 
	 * @param element
	 * @return
