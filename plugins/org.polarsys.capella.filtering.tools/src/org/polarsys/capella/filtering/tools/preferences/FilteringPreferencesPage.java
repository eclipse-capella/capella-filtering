...
/**
 * Variability preferences page. The Activator of this plugin contains the
 * listener to refresh when the user click Apply
 * 
 * 
 */
public class FilteringPreferencesPage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
	...
	public void createFieldEditors() {
		addField(new BooleanFieldEditor(FEATURES_DIAGRAM, Messages.FILTERING_PREFERENCES_PAGE_0,
				getFieldEditorParent()));
		addField(new BooleanFieldEditor(OPTIONAL_DIAGRAM, Messages.FILTERING_PREFERENCES_PAGE_1,
				getFieldEditorParent()));
		SpacerFieldEditor spacer = new SpacerFieldEditor(getFieldEditorParent());
		addField(spacer);
		addField(new BooleanFieldEditor(SAVE_DECORATORS_DIAGRAM, Messages.FILTERING_PREFERENCES_PAGE_2,
				getFieldEditorParent()));
		addField(spacer);
