...
public class FilteringCriteriaSelectionDialog extends CheckedTreeSelectionDialog {
	...
	/**
	 * This method has been overridden to be able to insert selection buttons
	 * between the top label and the tree viewer. {@inheritDoc}
	 */
	@Override
	...
	protected Composite createSelectionButtonsAfterMessageArea(Composite composite) {
		...
		final List<FilteringResult> filteringResults = FilteringUtils.getFilteringResults(projects);
		if (filteringResults.isEmpty()) {
			...
			configCombo.addListener(SWT.Selection, new Listener() {
				...
				public void handleEvent(Event e) {
					...
					// make sense
					Object[] selectedConfigurations = new Object[] { filteringResults.get(realIndex) };
	...
	protected Composite createSelectionButtons(Composite composite) {
		Composite buttonComposite = new Composite(composite, SWT.RIGHT) {
			/**
			 * This method has been overridden to have an "empty" size for this
			 * composite. {@inheritDoc}
			 * 
