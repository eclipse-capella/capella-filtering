...
public class FilteringSwitch<T> extends Switch<T> {
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Criterion</em>'. <!-- begin-user-doc --> This
   * implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
   * 
   * @param object
   *          the target of the switch.
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Criterion Set</em>'. <!-- begin-user-doc -->
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Results</em>'. <!-- begin-user-doc --> This
   * implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
   * 
   * @param object
   *          the target of the switch.
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Creation Default Filtering Criterion
   * Set</em>'. <!-- begin-user-doc --> This implementation returns null; returning a non-null result will terminate the
   * switch. <!-- end-user-doc -->
   * 
   * @param object
   *          the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Creation Default Filtering Criterion
   *         Set</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Result Pkg</em>'. <!-- begin-user-doc --> This
   * implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
   * 
   * @param object
   *          the target of the switch.
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Criterion Pkg</em>'. <!-- begin-user-doc -->
   * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
   * 
   * @param object
   *          the target of the switch.
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Result Set</em>'. <!-- begin-user-doc --> This
   * implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
   * 
   * @param object
   *          the target of the switch.
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Namespace</em>'. <!-- begin-user-doc --> This
   * implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
   * 
   * @param object
   *          the target of the switch.
