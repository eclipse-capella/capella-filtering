...
public interface FilteringPackage extends EPackage {
	 ...
	 * '{@link org.polarsys.capella.filtering.impl.FilteringCriterionSetImpl
	...
	/**
	 * The number of structural features of the '<em>Criterion Set</em>' class.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	...
	/**
	 * The meta object id for the
	 * '{@link org.polarsys.capella.filtering.impl.CreationDefaultFilteringCriterionSetImpl
	 * <em>Creation Default Filtering Criterion Set</em>}' class. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The meta object id for the
	 * '{@link org.polarsys.capella.filtering.impl.FilteringResultPkgImpl
	 * <em>Result Pkg</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	...
	/**
	 * The meta object id for the
	 * '{@link org.polarsys.capella.filtering.impl.FilteringCriterionPkgImpl
	...
	/**
	 * The number of structural features of the '<em>Criterion Pkg</em>' class.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	 ...
	 * '{@link org.polarsys.capella.filtering.FilteringCriterionSet#getFilteringCriteria
	 * <em>Filtering Criteria</em>}'. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @return the meta object for the reference list '<em>Filtering
	 *         Criteria</em>'.
	 ...
	 * '{@link org.polarsys.capella.filtering.FilteringResults#getFilteringResults
	 * <em>Filtering Results</em>}'. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @return the meta object for the containment reference list '<em>Filtering
	 *         Results</em>'.
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Owned Filtering
		 * Criteria</b></em>' containment reference list feature. <!--
		 * begin-user-doc --> <!-- end-user-doc -->
		 * 
		 * @generated
		 */
		...
		/**
		 * The meta object literal for the '<em><b>Owned Filtering Criterion
		 * Pkgs</b></em>' containment reference list feature. <!--
		 * begin-user-doc --> <!-- end-user-doc -->
		 * 
		 * @generated
		 */
		 ...
		 * '{@link org.polarsys.capella.filtering.impl.FilteringCriterionImpl
		...
		/**
		 * The meta object literal for the
		 * '{@link org.polarsys.capella.filtering.impl.FilteringResultsImpl
		...
		/**
		 * The meta object literal for the '<em><b>Owned Filtering Result
		 * Pkgs</b></em>' containment reference list feature. <!--
		 * begin-user-doc --> <!-- end-user-doc -->
		 * 
		 * @generated
		...
		/**
		 * The meta object literal for the
		 * '{@link org.polarsys.capella.filtering.impl.FilteringResultImpl
		...
		/**
		 * The meta object literal for the
		 * '{@link org.polarsys.capella.filtering.impl.AssociatedFilteringCriterionSetImpl
		 * <em>Associated Filtering Criterion Set</em>}' class. <!--
		 * begin-user-doc --> <!-- end-user-doc -->
		 * 
		 * @see org.polarsys.capella.filtering.impl.AssociatedFilteringCriterionSetImpl
		 * @see org.polarsys.capella.filtering.impl.FilteringPackageImpl#getAssociatedFilteringCriterionSet()
		...
		/**
		 * The meta object literal for the '<em><b>Owned Filtering
		 * Results</b></em>' containment reference list feature. <!--
		 * begin-user-doc --> <!-- end-user-doc -->
		 * 
		 * @generated
		 */
