 ...
 * </p>
 * <ul>
 * <li>{@link org.polarsys.capella.filtering.ComposedFilteringResult#getUnionFilteringResultSet <em>Union Filtering
 * Result Set</em>}</li>
 * <li>{@link org.polarsys.capella.filtering.ComposedFilteringResult#getIntersectionFilteringResultSet <em>Intersection
 * Filtering Result Set</em>}</li>
 * <li>{@link org.polarsys.capella.filtering.ComposedFilteringResult#getExclusionFilteringResultSet <em>Exclusion
 * Filtering Result Set</em>}</li>
 * </ul>
 *
...
public interface ComposedFilteringResult extends AbstractFilteringResult {
  ...
  /**
   * Sets the value of the '{@link org.polarsys.capella.filtering.ComposedFilteringResult#getUnionFilteringResultSet
   * <em>Union Filtering Result Set</em>}' containment reference.
   * 
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
   *          the new value of the '<em>Union Filtering Result Set</em>' containment reference.
   ...
   * Filtering Result Set</em>}' containment reference.
   * 
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
   *          the new value of the '<em>Intersection Filtering Result Set</em>' containment reference.
  ...
  /**
   * Sets the value of the '{@link org.polarsys.capella.filtering.ComposedFilteringResult#getExclusionFilteringResultSet
   * <em>Exclusion Filtering Result Set</em>}' containment reference.
   * 
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
   *          the new value of the '<em>Exclusion Filtering Result Set</em>' containment reference.
