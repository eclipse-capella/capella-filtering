 ...
 * <li>{@link org.polarsys.capella.filtering.impl.FilteringResultPkgImpl#getContainedGenericTraces <em>Contained Generic
 * Traces</em>}</li>
 * <li>{@link org.polarsys.capella.filtering.impl.FilteringResultPkgImpl#getContainedRequirementsTraces <em>Contained
 * Requirements Traces</em>}</li>
 * <li>{@link org.polarsys.capella.filtering.impl.FilteringResultPkgImpl#getNamingRules <em>Naming Rules</em>}</li>
 * <li>{@link org.polarsys.capella.filtering.impl.FilteringResultPkgImpl#getOwnedFilteringResults <em>Owned Filtering
 * Results</em>}</li>
 * <li>{@link org.polarsys.capella.filtering.impl.FilteringResultPkgImpl#getOwnedFilteringResultPkgs <em>Owned Filtering
 * Result Pkgs</em>}</li>
 * </ul>
 *
 * @generated
...
public class FilteringResultPkgImpl extends NamedElementImpl implements FilteringResultPkg {
  ...
  /**
   * The cached value of the '{@link #getOwnedFilteringResults() <em>Owned Filtering Results</em>}' containment
  ...
  /**
   * The cached value of the '{@link #getOwnedFilteringResultPkgs() <em>Owned Filtering Result Pkgs</em>}' containment
   * reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  public EList<AbstractFilteringResult> getOwnedFilteringResults() {
    ...
    if (ownedFilteringResults == null) {
      ownedFilteringResults = new EObjectContainmentEList<AbstractFilteringResult>(AbstractFilteringResult.class, this,
