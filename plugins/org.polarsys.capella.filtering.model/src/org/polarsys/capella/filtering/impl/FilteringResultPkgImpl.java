...
public class FilteringResultPkgImpl extends NamedElementImpl implements FilteringResultPkg {
	 ...
	 * @ordered
	 */
	protected EList<FilteringResult> ownedFilteringResults;

	/**
	 * The cached value of the '{@link #getOwnedFilteringResultPkgs() <em>Owned
	 * Filtering Result Pkgs</em>}' containment reference list. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	public EList<FilteringResult> getOwnedFilteringResults() {
		...
		if (ownedFilteringResults == null) {
			ownedFilteringResults = new EObjectContainmentEList<FilteringResult>(FilteringResult.class, this,
