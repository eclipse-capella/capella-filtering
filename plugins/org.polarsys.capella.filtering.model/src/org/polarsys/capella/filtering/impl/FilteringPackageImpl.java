...
public class FilteringPackageImpl extends EPackageImpl implements FilteringPackage {
   ...
   * 
   * <p>
   * This method is used to initialize {@link FilteringPackage#eINSTANCE} when that field is accessed. Clients should
  ...
  public void initializePackageContents() {
    ...
    initEClass(filteringResultsEClass, FilteringResults.class, "FilteringResults", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(getFilteringResults_FilteringResults(), this.getAbstractFilteringResult(), null, "filteringResults", //$NON-NLS-1$
    ...
    initEReference(getComposedFilteringResult_IntersectionFilteringResultSet(),
        ...
        ComposedFilteringResult.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
  ...
  /**
   * Initializes the annotations for <b>http://www.polarsys.org/kitalpha/dsl/2007/dslfactory</b>. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
   * @generated
   */
