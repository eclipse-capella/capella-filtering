 ...
 * </p>
 * <ul>
 * <li>{@link org.polarsys.capella.filtering.FilteringResultPkg#getOwnedFilteringResults <em>Owned Filtering
 * Results</em>}</li>
 * <li>{@link org.polarsys.capella.filtering.FilteringResultPkg#getOwnedFilteringResultPkgs <em>Owned Filtering Result
 * Pkgs</em>}</li>
 * </ul>
 *
...
public interface FilteringResultPkg extends Namespace {
  ...
  /**
   * Returns the value of the '<em><b>Owned Filtering Results</b></em>' containment reference list. The list contents
   * are of type {@link org.polarsys.capella.filtering.AbstractFilteringResult}.
   * 
   * <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * Returns the value of the '<em><b>Owned Filtering Result Pkgs</b></em>' containment reference list. The list
   * contents are of type {@link org.polarsys.capella.filtering.FilteringResultPkg}.
   * 
   * <!-- begin-user-doc -->
   * <p>
