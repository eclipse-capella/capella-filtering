    ...
    if (eType == EMFEventType.NULL) {
      if (eObj instanceof DeploymentTarget) {
        ...
        for (AbstractDeploymentLink dLink : location.getDeploymentLinks()) {
          ...
          List<FilteringCriterion> deployedElementFeatures = FilteringUtils.getAssociatedCriteria(deployedElement);
          List<FilteringCriterion> missingFeatures = ConstraintsUtil.missingFilteringCriteria(deployedElementFeatures,
              targetFeatures);
