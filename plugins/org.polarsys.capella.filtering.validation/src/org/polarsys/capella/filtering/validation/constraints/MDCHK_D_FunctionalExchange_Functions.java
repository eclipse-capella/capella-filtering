	...
	public IStatus validate(IValidationContext ctx) {
		...
		if (eType == EMFEventType.NULL) {
			if (eObj instanceof FunctionalExchange) {
				...
				List<FilteringCriterion> outputFunctionFeatures = FilteringUtils
						.getAssociatedCriteria(outputFunctionObject);
				...
				List<FilteringCriterion> inputFunctionFeatures = FilteringUtils
						.getAssociatedCriteria(inputFunctionObject);
