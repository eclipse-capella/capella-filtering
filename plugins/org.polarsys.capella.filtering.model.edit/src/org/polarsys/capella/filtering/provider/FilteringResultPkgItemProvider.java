...
/**
 * This is the item provider adapter for a {@link org.polarsys.capella.filtering.FilteringResultPkg} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class FilteringResultPkgItemProvider extends NamedElementItemProvider implements IEditingDomainItemProvider,
   ...
   * @generated
   */
  public FilteringResultPkgItemProvider(AdapterFactory adapterFactory) {
  ...
  /**
   * This adds a property descriptor for the Contained Generic Traces feature. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
   * @generated
   */
  ...
  /**
   * This adds a property descriptor for the Contained Requirements Traces feature. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   */
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
    if (childrenFeatures == null) {
      ...
      childrenFeatures.add(FilteringPackage.Literals.FILTERING_RESULT_PKG__OWNED_FILTERING_RESULTS);
      childrenFeatures.add(FilteringPackage.Literals.FILTERING_RESULT_PKG__OWNED_FILTERING_RESULT_PKGS);
    }
  ...
  /**
   * This returns FilteringResultPkg.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  @Override
  public Object getImage(Object object) {
    return overlayImage(object, getResourceLocator().getImage("full/obj16/FilteringResultPkg")); //$NON-NLS-1$
  }
  ...
  public String getText(Object object) {
    ...
    String label = ((FilteringResultPkg) object).getName();
    // begin-extension-code
    return label == null || label.length() == 0 ? "[" + getString("_UI_FilteringResultPkg_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    // end-extension-code
  }
  ...
  public void notifyChanged(Notification notification) {
    ...
    switch (notification.getFeatureID(FilteringResultPkg.class)) {
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
    ...
    // begin-extension-code
    {
      CommandParameter commandParameter = createChildParameter(CapellacorePackage.Literals.NAMESPACE__OWNED_TRACES,
    ...
    // begin-extension-code
    {
      CommandParameter commandParameter = createChildParameter(CapellacorePackage.Literals.NAMESPACE__NAMING_RULES,
    ...
    {
      CommandParameter commandParameter = createChildParameter(
          FilteringPackage.Literals.FILTERING_RESULT_PKG__OWNED_FILTERING_RESULTS,
          FilteringFactory.eINSTANCE.createFilteringResult());
      if (NewChildDescriptorHelper.isValidCommand(object, commandParameter)) {
        newChildDescriptors.add(commandParameter);
      }
    }
    ...
    // begin-extension-code
    {
      CommandParameter commandParameter = createChildParameter(
          FilteringPackage.Literals.FILTERING_RESULT_PKG__OWNED_FILTERING_RESULTS,
          FilteringFactory.eINSTANCE.createComposedFilteringResult());
      if (NewChildDescriptorHelper.isValidCommand(object, commandParameter)) {
        newChildDescriptors.add(commandParameter);
      }
    }
    ...
    {
      CommandParameter commandParameter = createChildParameter(
          FilteringPackage.Literals.FILTERING_RESULT_PKG__OWNED_FILTERING_RESULT_PKGS,
          FilteringFactory.eINSTANCE.createFilteringResultPkg());
      if (NewChildDescriptorHelper.isValidCommand(object, commandParameter)) {
        newChildDescriptors.add(commandParameter);
      }
    }
