 ...
 * @generated
 */
public class AbstractFilteringResultItemProvider extends NamedElementItemProvider implements IEditingDomainItemProvider,
   ...
   * @generated
   */
  public AbstractFilteringResultItemProvider(AdapterFactory adapterFactory) {
  ...
  public String getText(Object object) {
    ...
    String label = ((AbstractFilteringResult) object).getName();
    // begin-extension-code
    return label == null || label.length() == 0 ? "[" + getString("_UI_AbstractFilteringResult_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    // end-extension-code
  }
